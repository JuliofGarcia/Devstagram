            ...
            <img src="{{ asset('images/registrar.jpg') }}" alt="Imagen de registro de usuarios"
                ...
                <div class="md:w-1/2 bg-white p-6 rounded-lg shadow-xl ">
                    <form action="">
                        ...
                        <div class="mb-5">
                            <label for="email" class="mb-2 block uppercase font-bold text-gray-500">Email</label>
                            <input id="email" name="email" type="email" placeholder="Tu Email"
                                class="border p-3 w-full rounded-lg">
                        </div>
                        <div class="mb-5">
                            <label for="password" class="mb-2 block uppercase font-bold text-gray-500">Password</label>
                            <input id="password" name="password" type="password" placeholder="Tu Password"
                                class="border p-3 w-full rounded-lg">
                        </div>
                        <div class="mb-5">
                            <label for="password_confirmation" class="mb-2 block uppercase font-bold text-gray-500">Repetir
                                Password</label>
                            <input id="password_confirmation" name="password_confirmation" type="password"
                                placeholder="Repite tu Password" class="border p-3 w-full rounded-lg">
                        </div>
                        <input type="submit" value="Crear Cuenta"
                            class="bg-blue-600 hover:bg-red-500 transition-colors cursor-pointer uppercase font-bold w-full p-3 text-white rounded-lg">
                    </form>
                </div>
